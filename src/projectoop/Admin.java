...
public class Admin extends Employee {
    ...
    public void createStudent(Student e) {
        e.setId("S" + Storage.students.size());
    }
    public void createTeacher(Teacher t) {
        t.setId("T" + Storage.teachers.size());
    }
    public void createManager(Manager m) {
        m.setId("M" + Storage.managers.size());
    }
    public void createAdmin(Admin a) {
        a.setId("A" + Storage.admins.size());
    }

    public void createExecutor(Executor e) {
        e.setId("E" + Storage.executors.size());
    }
    ...
    public Admin create() {
        Vector<String> entities = new Vector<>
                (Arrays.asList(new String[]{"projectoop.Student",
                        "projectoop.Teacher",
                        "projectoop.Admin",
                        "projectoop.Manager",
                        "Cancel"
